...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var schoolContext = _context.Departments.Include(d => d.Administrator).Include(d => d.University);
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,Name,Budget,StartDate,InstructorID,UniversityID,RowVersion")] Department department)
        {
